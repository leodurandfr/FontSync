"""File watcher (watchdog) et scan périodique.

Les primitives de hachage (`ScannedFont`, `hash_file`, `scan_fonts`) vivent
désormais dans `agent.hashing` ; elles sont ré-exportées ici pour les
...
from agent.discovery import FONT_EXTENSIONS
